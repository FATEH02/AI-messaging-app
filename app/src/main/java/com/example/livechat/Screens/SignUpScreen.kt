...
fun SignUpScreen(navController: NavController,vm:LCViewModel)
{
  ...
  Box(modifier = Modifier.fillMaxSize())
  {
      ...
      val passwardState = remember{ mutableStateOf(TextFieldValue()) }
      val focus = LocalFocusManager.current
          ...
          OutlinedTextField(value = nameState.value,
           ...
           OutlinedTextField(value = passwardState.value,
              onValueChange = {
            passwardState.value = it
          },
...
@Composable
private fun  SignUp() {
    SignUpScreen(navController = TODO(), TODO())
}